...
class DynamicLayout extends StatelessWidget {
    ...
    switch (config['layout']) {
      ...
      case Layout.webEmbed:
        return FutureBuilder<bool>(
          future: checkStream(), // a previously-obtained Future<String> or null
 ...
 Future<bool> checkStream() async {
    String url =  ServerConfig().url=='https://english.publictv.in'?
    ...
    if (response.statusCode == 200) {
      ...
      // If the server returns any other status code, return false
      return false;
    }
 }
}
