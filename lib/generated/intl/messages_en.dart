...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "must be bought in groups of ${number}";

  static String m24(itemCount) => "${itemCount} items";

  static String m25(price) => "Options total: ${price}";

  static String m26(amount) => "Pay ${amount}";

  static String m27(total) => "Qty: ${total}";

  static String m28(percent) => "Sale ${percent}%";

  static String m29(second) => "${second} seconds ago";

  static String m30(totalCartQuantity) =>
      "Shopping cart, ${totalCartQuantity} items";

  static String m31(numberOfUnitsSold) => "Sold: ${numberOfUnitsSold}";

  static String m32(fieldName) => "The ${fieldName} field is required";

  static String m33(total) => "${total} products";
  ...
  static String m35(date) => "Valid til ${date}";

  static String m36(message) => "Warning: ${message}";
  ...
  static String m38(length) => "We found ${length} products";

  static String m39(week) => "Week ${week}";

  static String m40(name) => "Welcome ${name}";

  static String m41(year) => "${year} years ago";

  static String m42(total) => "You have assigned to order #${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "weWillSendYouNotification": MessageLookupByLibrary.simpleMessage(
            "We will send you notifications when news updates are published."),
